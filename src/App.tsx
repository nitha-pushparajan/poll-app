  ...
  return (
    <div className="App">
      <header className="App-header">
        {loading ? <div className="w-full h-full absolute flex justify-center items-center">
        <div role="status">
        ...
        <>
          {
            error ? 
              <div className="w-full h-full absolute flex justify-center items-center text-[#fff]">
                An error occured in fethcing data mock questions. Please try again or try with mock data
